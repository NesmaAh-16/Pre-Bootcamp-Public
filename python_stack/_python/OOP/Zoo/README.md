...
- **Method Overriding (Polymorphism):** Specific subclasses (like `Tiger`) override default behaviors (like `feed`) to reflect unique species characteristics.
...
3. **Tiger:** Overrides `feed()` with custom logic and specific console feedback.
